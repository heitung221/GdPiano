...
$(document).ready(function(){
	...
	var textsPart3 = "<p id=\"note\">Note: The chord names and symbols are used in popular music, which may be different in classical music. <p><br><br><br><br><br><span id = \"easterEgg\">Easter egg:</span>&nbsp;<select id=\"selectMode\"><option value = \"NormalMode\">Normal Mode</option><option value = \"JyutKukMode\">粵曲模式</option></select>&emsp;<a href = \"old.html\"class = \"button button-small button-outline\">Go To GdPiano ver. 1.11.1</a><br><span id=\"version\">GdPiano ver. "
	...
	function keyPush(evt){
		...
		//Description
		if (Layout == 1 || Layout == 2 || Layout == 3){
			$("#tutorial").text("Instruction: Press A to play Do, press S to play Re, press D to play Mi, and etc. Press Shift + A to play the key between Do and Re, press Shift + S to play the key between Re and Mi, and etc.");
			}
		else if (Layout == 4){
